...
<script src="{{ asset('backend/assets/js/e8b72830d1.js')}}"></script>

<script type="text/jacascript" src="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.js"></script>
