                        ...
                        <tbody>
                          @php($i = 1)
                           ...
                           <tr>
                            ...
                            <td>
                              {{-- <a href="{{ url('contacts/edit/'.$con->id) }}" class="btn  btn-info">Edit</a> --}}
                              <a href="{{ url('contacts/delete/'.$con->id) }}" onclick="return confirm('Are You Sure To Delete')" class="btn  btn-danger"><i class="far fa-trash-alt"></i> Delete</a>
                            </td>
                           </tr>
                         @endforeach
                        </tbody>
